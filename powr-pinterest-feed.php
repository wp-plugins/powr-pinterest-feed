<?php
    ...
    Description: Display any Pinterest board on your website!  Drop the widget anywhere in your theme. Or use the POWr icon in your WP text editor to add to a page or post. Edit on your live page by clicking the settings icon. More plugins and tutorials at POWr.io.
    Author: POWr.io
    Version: 1.4
    ...
    */
    ...
    class Powr_Pinterest_Feed extends WP_Widget{
      ...
      public function form( $instance ){
        ?>
        <p>
          No need to edit here - just click the gears icon on your Pinterest Feed.
        </p>
        <p>
